	...
	<div class="container">
		<table class="table table-boarded table-hover" style="text-align: center; border: 1px solid #dddddd">
			<thead>
				...
				<tr>
					<td style="background: #fafafa; color: #000000; width: 80px;"><h5>제목</h5></td>
					<td colspan="3"><h5><%= board.getboardTitle() %></h5></td>
				</tr>
				<tr>
					<td style="background: #fafafa; color: #000000; width: 80px;"><h5>작성자</h5></td>
					<td colspan="3"><h5><%= board.getUserID() %></h5></td>
				</tr>
				<tr>
					<td style="background: #fafafa; color: #000000; width: 80px;"><h5>작성날짜</h5></td>
					<td><h5><%= board.getBoardDate()%></h5></td>
					<td style="background: #fafafa; color: #000000; width: 80px;"><h5>조회수</h5></td>
					<td><h5><%= board.getBoardHit() + 1%></h5></td>
				</tr>
				<tr>
					<td style="vertical-align: middle; min-height: 150px; background: #fafafa; color: #000000; width: 80px;"><h5>글 내용</h5></td>
					<td colspan="3" style="text-align: left;"><h5><%= board.getBoardContent() %></h5></td>
				</tr>
				<tr>
					<td style="background: #fafafa; color: #000000; width: 80px;"><h5>첨부파일</h5></td>
